...
| HTTP Method | Endpoint                                 | Parâmetros                                     | Descrição                                       | Retornos Possíveis                                                                                                                                      |
|-------------|------------------------------------------|------------------------------------------------|-------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| GET         | /Chat/{emailUsuario}/{senhaUsuario}/{id} | emailUsuario: String, senhaUsuario: String, id: Int | Retorna as informações de um chat específico | 200 OK: caso encontre o chat e o usuário tenha permissão para acessá-lo. 401 Unauthorized: caso não encontre o usuário. 404 Not Found: caso não encontre o chat. 500 Internal Server Error: em caso de erro interno do servidor. |
| GET         | /Chat/getAll/{emailUsuario}/{senhaUsuario} | emailUsuario: String, senhaUsuario: String     | Retorna todos os chats do usuário               | 200 OK: caso encontre os chats do usuário. 401 Unauthorized: caso não encontre o usuário. 500 Internal Server Error: em caso de erro interno do servidor.          |
| POST        | /Chat/{emailUsuario}/{senhaUsuario}/{idUsuario} | emailUsuario: String, senhaUsuario: String, idUsuario: Int | Cria um novo chat com o usuário especificado | 200 OK: caso o chat seja criado com sucesso. 401 Unauthorized: caso não encontre o usuário. 404 Not Found: caso não encontre o usuário especificado para criar o chat. 409 Conflict: caso já exista um chat entre o usuário e o usuário especificado. 500 Internal Server Error: em caso de erro interno do servidor. |
| DELETE      | /Chat/{emailUsuario}/{senhaUsuario}/{id} | emailUsuario: String, senhaUsuario: String, id: Int | Exclui um chat específico                    | 200 OK: caso o chat seja excluído com sucesso. 401 Unauthorized: caso não encontre o usuário. 404 Not Found: caso não encontre o chat. 500 Internal Server Error: em caso de erro interno do servidor. |
