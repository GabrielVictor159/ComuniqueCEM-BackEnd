...
public class MensagensControllerTest {
        ...
        public void confirmarEntregaTest() throws NoSuchMethodException {
                ...
                Mensagens mensagemTeste = ModelCadastrosTests.CadastrarMensagem(chat, usuario1.getIdUsuario(),
                                mensagensService);
        ...
        public void setLidaChat() throws NoSuchMethodException {
                ...
                Mensagens message = ModelCadastrosTests.CadastrarMensagem(novoChat, novoUsuario.getIdUsuario(),
                                mensagensService);
                ResponseEntity<Object> response = testRestTemplate.exchange(
                                URI,
                                HttpMethod.PUT,
